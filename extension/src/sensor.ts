...
// v11.86, value redaction, the 128KB/400-node cap). The types come from the extension wire contract;
// a malformed snapshot is rejected at the app gateway by zod, not patched here.
import type { PageSnapshot, SnapNode, SnapNodeStates, SnapNodeAttrs, SnapRole } from './protocol.js';
import { CAPS } from './protocol.js';
...
const MAX_NAME = 200; //   SnapNode.name is capped at 200 chars in the contract
